...
- **拖尾残影**：闲逛和拖动时，身后拖出 4 个渐隐残影窗口（透明度 22% → 4%）
...
**关键参数：** lerp 0.25、下落加速 0.8 px/tick²、最大 16 px/tick、落地 6 秒冷却防震荡

---

### 9. 桌面痕迹系统 (`desktop_marks.py`)

用户空闲 >30 分钟时在桌面留下 paw / Zzz / star / heart 等痕迹，独立透明窗口，淡入 2s → 存活 10 分钟 → 淡出 3s，最多 5 个。
